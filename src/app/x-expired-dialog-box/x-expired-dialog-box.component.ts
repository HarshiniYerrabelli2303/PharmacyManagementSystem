...
import { EmailInteractionService } from '../services/email-Interaction.service';
...
export class XExpiredDialogBoxComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data : any, public emailInteractionService: EmailInteractionService , private snackBar: MatSnackBarModule) { }
